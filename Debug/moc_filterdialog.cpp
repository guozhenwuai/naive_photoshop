...
QT_MOC_LITERAL(1, 13, 15), // "sendApplyFilter"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "apply"
QT_MOC_LITERAL(4, 36, 18) // "buttonGroupChanged"

    },
    "FilterDialog\0sendApplyFilter\0\0apply\0"
    "buttonGroupChanged"
};
...
void FilterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendApplyFilter((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        ...
        {
            typedef void (FilterDialog::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterDialog::sendApplyFilter)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterDialog::sendApplyFilter(QJsonObject _t1)
{
