...
QT_MOC_LITERAL(1, 16, 30), // "sendApplyHistogramEqualization"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 17) // "histogramEqualize"

    },
    "HistogramDialog\0sendApplyHistogramEqualization\0"
    "\0histogramEqualize"
};
...
void HistogramDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendApplyHistogramEqualization((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 1: _t->histogramEqualize(); break;
        default: ;
        }
        ...
        {
            typedef void (HistogramDialog::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HistogramDialog::sendApplyHistogramEqualization)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HistogramDialog::sendApplyHistogramEqualization(QImage _t1)
{
